<script setup>
    ...
    import { useHeadOfFamilyStore } from '@/stores/head-of-family';
    ...
    const fetchData = async () => {
        await fetchHeadOfFamiliesPaginated({ ...serverOptions, ...filters.value})
    }
            ...
            <form id="Page-Search" class="flex items-center justify-between">
                ...
                <div class="options flex items-center gap-4">
                    <div class="flex items-center gap-[10px]">
                        ...
                        <div class="relative">
                            <select v-model="serverOptions.per_page"
