...
const useSocialAssistanceRecipientStore = useSocialAssistanceRecipientStore()
const { socialAssistanceRecipients, meta, loading, error, success } = storeToRefs(useSocialAssistanceRecipientStore)
const { fetchSocialAssistanceRecipientsPaginated } = useSocialAssistanceRecipientStore
